...
interface SliderTvProps {
  handleChangeSlide: ((swiper: any) => void) | undefined;
  listData: Tv[];
  tvActive: number;
}
...
const TopTv = () => {
  ...
  return (
    <div className="container relative">
      ...
      <div className=" flex justify-end md:justify-between h-[400px] top-slide my-10">
        <div className="absolute w-full h-full overflow-hidden md:flex-1 md:relative">
          <motion.div
          ...
          <>
            ...
            >
              ...
              <p className="md:w-[600px] w-[150px] sm:w-[300px] overflow-hidden text-xs font-semibold lg:text-sm line-clamp-3">
...
const SliderTv = ({ handleChangeSlide, listData, tvActive }: SliderTvProps) => {
  return (
    <div className="overflow-hidden w-[200px] lg:w-[300px]">
      <Swiper
        direction={"vertical"}
        slidesPerView={4}
        spaceBetween={30}
